<template>
  <div class="pagination" role="group" aria-label="分页"><!--btn-default-->
    <button type="button" class="btn  btn-white btn-round"
    ...
    <button v-for="p in pages" v-bind:id="'page-' + p"
            type="button" class="btn  btn-white btn-round"
    ...
    <button type="button" class="btn btn-white btn-round"
            v-bind:disabled="page === pageTotal||pageTotal===0"
            v-on:click="selectPage(page + 1)">
      下一页 <!--{{page}}&#45;&#45;{{pageTotal}}-->
    </button>
    <button type="button" class="btn  btn-white btn-round"
