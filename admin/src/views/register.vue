                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-9">
                                    <input type="text" placeholder="请输入用户名" class="form-control col-xs-10 col-sm-5" v-model="users.uname"  @blur="checkName();" />
                                </div>
                            </div>
                            <div class="form-group" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-sm-9">
                                    <input type="password" placeholder="请输入密码" class="form-control col-xs-10 col-sm-5" v-model="pwd" />
                                </div>
                            </div>
                            <div class="form-group" >
                                <label class="col-sm-3 control-label no-padding-right" > 角色 </label>
                                <div class="col-sm-9">
                                    <select v-model="users.utype" class="form-control" >
                            ...
                            <!--<div class="form-group" >
                                ...
                                <div class="col-sm-9">
                                    <input type="text" placeholder="请输入目前状态" class="form-control col-xs-10 col-sm-5" v-model="users.status" />
                                </div>
                            </div>-->
                            <div class="form-group" >
