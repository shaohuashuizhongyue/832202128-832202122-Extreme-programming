                    ...
                    <form class="form-horizontal" ><!--role="form"-->
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h4 class="panel-title">修改个人信息</h4>
                                <p></p>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-sm-9" style="margin-top: 10px;" v-html="users.id">
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 用户名 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入用户名" class="form-control col-xs-10 col-sm-5" v-model="users.uname" readonly="true"/>
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 姓名 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入姓名" class="form-control col-xs-10 col-sm-5" v-model="users.name" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入地址" class="form-control col-xs-10 col-sm-5" v-model="users.address" />
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 密码 </label>
                                    <div class="col-sm-9">
                                        <input type="password" placeholder="请输入密码" class="form-control col-xs-10 col-sm-5" v-model="users.pwd" />
                                    </div>
                                </div>
                                <!--<div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 角色 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入角色" class="form-control col-xs-10 col-sm-5" v-model="users.utype" readonly="true"/>
                                    </div>
                                </div>-->
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 电话 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入电话" class="form-control col-xs-10 col-sm-5" v-model="users.tel" />
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 年龄 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入年龄" class="form-control col-xs-10 col-sm-5" v-model="users.age" />
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 邮箱 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入邮箱" class="form-control col-xs-10 col-sm-5" v-model="users.email" />
                                    </div>
                                </div>
    ...
    export default {
        ...
        mounted:function () {
            ...
            if (_this.loginUser.id!=null) {
                _this.users=_this.loginUser;
                //_this.users.utype=SessionStorage.get("UTYPE");
            }else {
            ...
            save() {
                ...
                _this.$ajax.post(_this.$javaurl+"/admin/users/save", _this.users).then((response)=>{
                    ...
                    if (resp=="success") {
                        Toast.success("保存成功！");
                        //alert("保存成功！");
                       /* if (_this.users.utype=='管理员'){
                            _this.$router.push("/users");
                        }
                        if (_this.users.utype=='普通用户'){
                            _this.$router.push("/users/js");
                        }*/
