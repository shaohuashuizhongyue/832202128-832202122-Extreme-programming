                    ...
                    <form class="form-horizontal" ><!--role="form"-->
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">修改联系人</h4>
                                <p></p>
                            </div>
                            <div class="panel-body">
                                <div class="space-4">  <input hidden v-model="liaison.id" /></div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 姓名 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入姓名" class="form-control col-xs-10 col-sm-5" v-model="liaison.name" />
                                    </div>
                                </div>
                                <div class="form-group" >
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" placeholder="请输入年龄" class="form-control col-xs-10 col-sm-5" v-model="liaison.age" />
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 电话号码 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入电话号码" class="form-control col-xs-10 col-sm-5" v-model="liaison.tel" />
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 电子邮件地址 </label>
                                    <div class="col-sm-9">
                                        <input type="mail" placeholder="请输入电子邮件地址" class="form-control col-xs-10 col-sm-5" v-model="liaison.email" />
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 社交媒体账号 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入社交媒体账号" class="form-control col-xs-10 col-sm-5" v-model="liaison.maccount" />
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label class="col-sm-3 control-label no-padding-right" > 物理地址 </label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="请输入物理地址" class="form-control col-xs-10 col-sm-5" v-model="liaison.address" />
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    export default {
        ...
        mounted:function () {
            ...
            if (_this.loginUser.id!=null) {
                _this.liaison=SessionStorage.get("LIAISON");
            }else {
